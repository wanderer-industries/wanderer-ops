defmodule WandererOps.CachedInfo do
  use Task
  ...
  alias WandererOps.EveDataService

  def run(_arg) do
    Logger.info("Starting CachedInfo task")
    cache_system_static_info()
  end

  def cache_system_static_info() do
    EveDataService.get_db_data()
    |> Enum.each(fn system ->
      Cachex.put(
  ...
  #     {:ok, nil} ->
  #       wormhole_types = WandererOps.EveDataService.load_wormhole_types()
  ...
  #   case WandererOps.Cache.lookup(:wormhole_classes) do
  #     {:ok, nil} ->
  #       wormhole_classes = WandererOps.EveDataService.load_wormhole_classes()
  ...
  # def get_effects() do
  #   case WandererOps.Cache.lookup(:effects) do
  #     {:ok, nil} ->
  #       effects = WandererOps.EveDataService.load_effects()
  ...
  #   case WandererOps.Cache.lookup(:wh_class_a_systems) do
  #     {:ok, nil} ->
  #       {:ok, wh_class_a} = WandererOps.Api.MapSolarSystem.get_wh_class_a()
  ...
  #   case WandererOps.Cache.lookup(:trig_systems) do
  #     {:ok, nil} ->
  #       {:ok, trig_systems} = WandererOps.Api.MapSolarSystem.get_trig_systems()
  ...
  #   trig_systems = WandererOps.Api.MapSolarSystem.get_trig_systems!()
  ...
  # defp cache_items(items, list_name), do: WandererOps.Cache.put(list_name, items)
end
