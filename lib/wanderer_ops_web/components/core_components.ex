defmodule WandererOpsWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block w-full rounded-lg text-white focus:ring-0 sm:text-sm sm:leading-6 min-h-[6rem] bg-transparent",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WandererOpsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WandererOpsWeb.Gettext, "errors", msg, opts)
    end
  end
