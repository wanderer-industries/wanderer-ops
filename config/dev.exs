...
config :wanderer_ops, WandererOpsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "yauiXcvoh5b5z7Y4cqxganDwyhiaxl5DKdHoImOGw7TpK120ZPUIXTpDaZvfMlS9",
  watchers: [
...
config :wanderer_ops, WandererOpsWeb.Endpoint,
  ...
  live_reload: [
    notify: [
      live_view: [
        ~r"lib/wanderer_ops_web/core_components.ex$",
        ~r"lib/wanderer_ops_web/(live|components)/.*(ex|heex)$"
      ]
    ],
    patterns: [
      ~r"priv/static/(?!uploads/).*(js|css|png|jpeg|jpg|gif|svg)$",
      ~r"priv/gettext/.*(po)$",
      ~r"lib/wanderer_ops_web/controllers/.*(ex|heex)$"
    ]
  ]
