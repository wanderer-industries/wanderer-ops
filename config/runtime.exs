import Config
import WandererOps.ConfigHelpers
...
#
#     PHX_SERVER=true bin/wanderer_ops start
#
...
if config_env() == :prod do
  ...
  config :wanderer_ops, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :wanderer_ops, WandererOps.Mailer,
